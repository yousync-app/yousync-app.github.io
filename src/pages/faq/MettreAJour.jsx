  ...
  return (
    <FaqLayout title="Comment mettre à jour YouSync ?">
      <ol className="space-y-4 text-gray-300">
        <li>1. Téléchargez la dernière version depuis <a href="https://yousync-app.github.io/" className="text-primary hover:underline">notre page de téléchargement</a>.</li>

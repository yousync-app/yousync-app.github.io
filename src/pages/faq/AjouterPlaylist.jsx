    ...
    <FaqLayout title="Comment ajouter une playlist ?">
      <ol className="space-y-6 text-gray-300">
        <li>
          ...
          <img src="/tuto/add/1.png" alt="Accéder à la section Home" className="rounded-lg shadow-lg mx-auto" />
        </li>
        <li>
          <p>2. Sélectionnez la plateforme de streaming de votre choix (YouTube, Spotify, Apple Music).</p>
          <img src="/tuto/add/2.png" alt="Sélectionner la plateforme" className="rounded-lg shadow-lg mx-auto" />
        </li>
        <li>
          <p>3. Collez l'URL de votre playlist dans le champ prévu à cet effet.</p>
          <img src="/tuto/add/3.png" alt="Coller l'URL de la playlist" className="rounded-lg shadow-lg mx-auto" />
        </li>
        <li>
          <p>4. Cliquez sur l'icône de dossier pour sélectionner l'emplacement de sauvegarde sur votre ordinateur.</p>
          <img src="/tuto/add/4.png" alt="Sélectionner l'emplacement de sauvegarde" className="rounded-lg shadow-lg mx-auto" />
        </li>
        <li>
        ...
        <li>
          ...
          <img src="/tuto/add/5.png" alt="Sauvegarder la configuration" className="rounded-lg shadow-lg mx-auto" />
        </li>
      </ol>
    </FaqLayout>
  );
